...
function ModuleCard({ title, emoji, color, lessons, completed, locked = false }: ModuleCardProps) {
  const percentage = (completed / lessons) * 100
  
  return (
    <div
      className={`relative bg-white rounded-[32px] p-6 shadow-lg hover:shadow-xl transition-all cursor-pointer border-2 ${
